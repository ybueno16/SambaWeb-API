...
/**
 * Aspecto para processar automaticamente as anotações de operação do Swagger para métodos de
 * controladores anotados com {@link DefaultOperation}.
 */
@Aspect
@Component
public class SwaggerAspect {
  ...
  /**
   * Intercepta métodos de controladores anotados com {@link DefaultOperation} para processar e
   * definir valores padrão das anotações de operação do Swagger.
   *
  ...
  public void processDefaultOperation(JoinPoint joinPoint) throws Throwable {
    ...
    if (method != null) {
      DefaultOperation defaultOperation =
          AnnotationUtils.findAnnotation(method, DefaultOperation.class);
